...
const sizeClasses = {
  ...
  lg: 'w-8 h-8',
  xl: 'w-12 h-12',
  '2xl': 'w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24'
}

// 📋 Icono de archivo/documento (para instrucciones)
...
// 🛒 Icono del carrito (para materiales)
...
// ✂️ Icono de tijeras (para cortes precisos)
export const ScissorsIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg
    className={`${sizeClasses[size]} ${className}`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
// 🛠️ Icono de herramientas (para soporte técnico)
export const ToolsIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
  <svg
    className={`${sizeClasses[size]} ${className}`}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
