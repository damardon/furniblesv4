...
export class FeesController {
  ...
  @ApiOperation({
    ...
    description:
      'Retorna las configuraciones de fee activas. Administradores ven todas, sellers solo las que les aplican.',
  })
  @ApiQuery({
    name: 'type',
    required: false,
    description: 'Filtrar por tipo de fee',
  })
  @ApiQuery({
    name: 'country',
    required: false,
  ...
  @ApiOperation({
    ...
    description:
      'Actualiza una configuración de fee existente. Solo administradores.',
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiQuery({
    name: 'country',
    required: false,
    description: 'País del comprador',
  })
  @ApiQuery({
    name: 'category',
    required: false,
