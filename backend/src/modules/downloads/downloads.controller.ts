...
export class DownloadsController {
  ...
  @ApiOperation({
    ...
    description:
      'Retorna todos los tokens de descarga disponibles para una orden completada.',
  })
  @ApiParam({
    name: 'orderId',
  ...
  @ApiOperation({
    ...
    description:
      'Descarga un archivo PDF usando un token de descarga válido. No requiere autenticación.',
  })
  @ApiParam({
    name: 'token',
