...
export class AnalyticsController {
  ...
  @ApiOperation({
    ...
    description:
      'Comprehensive dashboard metrics for sellers including revenue, orders, products, and reviews',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Detailed revenue analytics including trends, breakdowns, and fee analysis',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Product performance analytics including top performers, ratings, and conversion metrics',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Review analytics including ratings distribution, response rates, and recent activity',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Customer analytics including repeat buyers, lifetime value, and acquisition metrics',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Notification engagement analytics including open rates, click rates, and type breakdown',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Conversion funnel analytics and optimization insights for seller products',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Platform-wide analytics including users, revenue, orders, and growth metrics',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Top performing sellers, products, categories, and buyers with detailed metrics',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiQuery({
    name: 'type',
    required: true,
    enum: ['sellers', 'products', 'categories', 'buyers'],
  })
  ...
  @ApiOperation({
    ...
    description:
      'Platform-wide conversion funnel analysis with drop-off points and optimization insights',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Platform-wide notification engagement analytics with trends and breakdowns',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'User journey analysis, activity patterns, and engagement metrics',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Comprehensive financial report with revenue, fees, and payment analysis',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Export analytics data in various formats (CSV, XLSX, PDF, JSON)',
  })
  @ApiResponse({
    status: 200,
  ...
  async getCacheStatus(@Req() req: any): Promise<any> {
    if (req.user.role !== 'ADMIN') {
      throw new ForbiddenException('Only admin can access this endpoint');
    }
