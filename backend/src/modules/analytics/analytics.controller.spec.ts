...
const mockHealthResponse = {
  ...
  services: {
    ...
    analytics: {
      status: 'healthy',
      lastCalculation: '2024-06-26T12:00:00.000Z',
    },
  },
};
...
describe('AnalyticsController', () => {
  ...
  describe('Seller Analytics Endpoints', () => {
    describe('getSellerDashboard', () => {
      it('should return seller dashboard for seller user', async () => {
        // Arrange
        mockAnalyticsService.getSellerDashboard.mockResolvedValue(
          mockSellerDashboardResponse,
        );
        ...
        expect(mockAnalyticsService.getSellerDashboard).toHaveBeenCalledWith(
          mockSellerId,
          dto,
        );
      });
      ...
      it('should throw ForbiddenException for admin without sellerId', async () => {
        ...
        // Act & Assert
        await expect(
          controller.getSellerDashboard(dto, req as any),
    ...
    describe('getSellerRevenue', () => {
      it('should return seller revenue analytics', async () => {
        ...
        expect(mockAnalyticsService.getSellerRevenue).toHaveBeenCalledWith(
          mockSellerId,
          dto,
        );
      });
    ...
    describe('getSellerProducts', () => {
      it('should return seller products analytics', async () => {
        ...
        mockAnalyticsService.getSellerProducts.mockResolvedValue(
        ...
        expect(mockAnalyticsService.getSellerProducts).toHaveBeenCalledWith(
          mockSellerId,
          dto,
        );
      });
    ...
    describe('getSellerReviews', () => {
      it('should return seller reviews analytics', async () => {
        ...
        mockAnalyticsService.getSellerReviews.mockResolvedValue(
          mockReviewsResponse,
        );
        ...
        expect(mockAnalyticsService.getSellerReviews).toHaveBeenCalledWith(
          mockSellerId,
          dto,
        );
      });
  ...
  describe('Admin Analytics Endpoints', () => {
    describe('getPlatformOverview', () => {
      it('should return platform overview for admin', async () => {
        // Arrange
        mockAnalyticsService.getPlatformOverview.mockResolvedValue(
          mockPlatformOverviewResponse,
        );
      ...
      it('should throw ForbiddenException for non-admin user', async () => {
        ...
        // Act & Assert
        await expect(
          controller.getPlatformOverview(dto, req as any),
        ).rejects.toThrow(ForbiddenException);
    ...
    describe('getTopPerformers', () => {
      it('should return top performers for admin', async () => {
        ...
        mockAnalyticsService.getTopPerformers.mockResolvedValue(
          mockTopPerformersResponse,
        );
        ...
        expect(mockAnalyticsService.getTopPerformers).toHaveBeenCalledWith(
          dto,
          mockAdminId,
        );
      });
    ...
    describe('getSellerComparison', () => {
      it('should return seller comparison for admin', async () => {
        ...
        mockAnalyticsService.getSellerComparison.mockResolvedValue(
        ...
        expect(mockAnalyticsService.getSellerComparison).toHaveBeenCalledWith(
          dto,
          mockAdminId,
        );
      });
  ...
  describe('Export and Reporting Endpoints', () => {
    describe('exportData', () => {
      ...
      it('should throw ForbiddenException for non-admin/non-s user', async () => {
        ...
        // Act & Assert
        await expect(controller.exportData(dto, req as any)).rejects.toThrow(
          ForbiddenException,
        );
    ...
    describe('scheduleReport', () => {
      it('should schedule report for admin', async () => {
        ...
        mockAnalyticsService.scheduleReport.mockResolvedValue(
        ...
        expect(mockAnalyticsService.scheduleReport).toHaveBeenCalledWith(
          dto,
          mockAdminId,
        );
      });
    ...
    describe('downloadReport', () => {
      it('should download report for authorized user', async () => {
        ...
        mockAnalyticsService.downloadReport.mockResolvedValue(
        ...
        expect(mockAnalyticsService.downloadReport).toHaveBeenCalledWith(
          reportId,
          mockAdminId,
          UserRole.ADMIN,
        );
  ...
  describe('Chart Data Endpoints', () => {
    describe('getSellerRevenueChart', () => {
      it('should return chart data for seller', async () => {
        // Arrange
        mockAnalyticsService.getSellerRevenueChart.mockResolvedValue(
          mockChartResponse,
        );
        ...
        // Act
        const result = await controller.getSellerRevenueChart(
          sellerId,
          dto,
          req as any,
        );
        ...
        expect(mockAnalyticsService.getSellerRevenueChart).toHaveBeenCalledWith(
          sellerId,
          dto,
        );
      });
    ...
    describe('getPlatformOverviewChart', () => {
      it('should return platform chart data for admin', async () => {
        ...
        mockAnalyticsService.getPlatformOverviewChart.mockResolvedValue(
          mockPlatformChartResponse,
        );
        ...
        // Act
        const result = await controller.getPlatformOverviewChart(
          dto,
          req as any,
        );
        ...
        expect(
          mockAnalyticsService.getPlatformOverviewChart,
      ...
      it('should throw ForbiddenException for non-admin user', async () => {
        ...
        // Act & Assert
        await expect(
          controller.getPlatformOverviewChart(dto, req as any),
        ).rejects.toThrow(ForbiddenException);
  ...
  describe('System Health Endpoints', () => {
    ...
    describe('getCacheStatus', () => {
      it('should return cache status', async () => {
        ...
        mockAnalyticsService.getCacheStatus.mockResolvedValue(
          mockCacheResponse,
        );
      ...
      it('should throw ForbiddenException for non-admin user', async () => {
        ...
        // Act & Assert
        await expect(controller.getCacheStatus(req as any)).rejects.toThrow(
          ForbiddenException,
        );
  ...
  describe('Authorization Logic', () => {
    ...
    it('should handle mixed authorization scenarios', async () => {
      ...
      await expect(
        controller.getPlatformOverview({}, req as any),
      ).rejects.toThrow(ForbiddenException);
  ...
  describe('HTTP Status Codes', () => {
    ...
    it('should handle POST requests with 200/201 status codes', async () => {
      ...
      const scheduleResult = await controller.scheduleReport(
        scheduleDto,
        req as any,
      );
  ...
  describe('Role-based Access Control', () => {
      ...
      const adminOnlyEndpoints = [
        ...
        () =>
          controller.getTopPerformers(
            { type: 'sellers' } as any,
            { user: mockSellerUser } as any,
          ),
        () =>
          controller.getSellerComparison(
            { sellerIds: [] } as any,
            { user: mockSellerUser } as any,
          ),
        () =>
        ...
        () =>
          controller.getPlatformOverviewChart({}, {
            user: mockSellerUser,
          } as any),
    ...
    it('should allow multi-role endpoints with proper access control', async () => {
      ...
      // Seller access
      await expect(
        controller.exportData(exportDto, { user: mockSellerUser } as any),
      ).resolves.toEqual(mockExportResponse);

      await expect(
        controller.generateCustomReport(customReportDto, {
          user: mockSellerUser,
        } as any),
      ).resolves.toEqual(mockExportResponse);

      await expect(
        controller.downloadReport('report123', { user: mockSellerUser } as any),
      ).resolves.toEqual({ success: true });

      // Admin access
      await expect(
        controller.exportData(exportDto, { user: mockAdminUser } as any),
      ).resolves.toEqual(mockExportResponse);
      ...
      await expect(
        controller.downloadReport('report123', { user: mockAdminUser } as any),
      ).resolves.toEqual({ success: true });
    });
  });
  ...
  describe('Chart Data Access Control', () => {
    ...
    it('should prevent sellers from accessing other sellers chart data', async () => {
      ...
      // Act & Assert
      await expect(
        controller.getSellerRevenueChart(otherSellerId, dto, req as any),
      ).rejects.toThrow(ForbiddenException);
  ...
  describe('Edge Cases and Boundary Conditions', () => {
    it('should handle empty query parameters', async () => {
      ...
      // Act & Assert
      await expect(
        controller.getSellerDashboard({}, req as any),
      ).rejects.toThrow(ForbiddenException);
    });
